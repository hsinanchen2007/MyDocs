...
Output: [[1, 7, 4], [1, 9, 2]]Explanation: Here are the two paths with sum '12':1 -> 7 -> 4 and 1 -> 9 -> 2
...
Output: [[12, 7, 4], [12, 1, 10]]Explanation: Here are the two paths with sum '23':12 -> 7 -> 4 and 12 -> 1 -> 10
