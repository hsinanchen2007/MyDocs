#ifndef DS2_SKIPLIST_5_SKIPLIST
#define DS2_SKIPLIST_5_SKIPLIST
...
class SkipList
{
 public:
  ...
  SkipList();
  SkipList(const SkipList& source);
  ~SkipList();
...
#include "ds2/SkipList/common/memberFunctions_5.h"
#include "ds2/SkipList/insert/insert_3.h"

#endif // DS2_SKIPLIST_5_SKIPLIST
